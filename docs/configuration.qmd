...
| `POSITRON_ENFORCED_SETTINGS` | A single-line JSON object of Positron settings to lock at the application level. Users cannot override enforced settings via the Settings UI or `settings.json`. Requires `jupyter-positron-server >= 0.0.4` and Positron Server `>= 2026.05.179`. |
...
**Requirements:** `jupyter-positron-server >= 0.0.4`, Positron Server `>= 2026.06.0`
