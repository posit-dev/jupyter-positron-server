---
title: "Get Started (versions 2026.05.0 and older)"
---

::: callout-important
This is the getting started workflow for versions of Positron 2026.05.0 and older. 
It is no longer the recommended workflow.
To update to the latest version, check out the [Get Started page](get_started.qmd).
:::
...
For the legacy setup, you will need version `0.0.4` (recommended) or lower.

```shell
pip install jupyter-positron-server==0.0.4
```
